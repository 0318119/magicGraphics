<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US" prefix="og: http://ogp.me/ns#" class="no-js" data-layout-name="shot-on-iphone" style="overflow-x:hidden;">
...
<body class="home-page">
            ...
            <div class="row align-items-center">
                <div class="col-md-3">
                    <a href="index.html" class="header-logo">
                        Logo Here
                        <!-- <img src="assets/images/logo.gif" alt="" width="120"> -->
                    </a>
                </div>
                <div class="col-md-9">
                    <div class="phoneInfo">
                        <ul>
                            ...
                            <li>
                                <a href="tel:(510) 216-7072"><i class="tell-icon for-sprite"></i> Call 24/7: <span>(510)
                                        216-7072</span></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 privacy">
                    <div class="term-text">
                        ...
                        <p>At Fix My Webs the protection of our customers is our top need on https://fixmywebs.com and
                            we regard it as our own. In spite of the fact that we gather data from our customers, it is
                            just used to make enhancements in our client administrations. Our organization recognizes
                            that the support and utilization of our customers’ data is our obligation. We DO NOT lease
                            or offer the data that our customers give us on the web.</p>
                        ...
                        <p>The data gathered by Fix My Webs incorporates the customer’s name, email, postage information
                            and telephone number. These are bits of data that the customer gives us while requesting or
                            while sparing the data with our organization. We may likewise utilize the email addresses or
                            street numbers which we get through our mailing framework, for example, our Contact Us Form
                            for reacting to remarks, questions and so on.</p>
                        ...
                        <p>On the off chance that you no more wish to get our pamphlet and limited time correspondences,
                            ...
                            correspondence or by messaging us at Or calling us at (510) 216-7072 </p>
                        ...
                        <p>In the event that you have any inquiries concerning security on our Web website, you can send
                            email us at info@Magic Graphics Design.com</p>
                        ...
                        <p>On the off chance that you have any inquiries with respect to our Privacy Policy or our
                            utilization of your data, call our toll free number ((510) 216-7072 ) or email us on
                            info@fixmywebs.com</p>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; Copyright 2022 Magic Graphics Design. All Rights Reserved</p>
                </div>
                <div class="col-md-6">
                    <p class="text-right">
                        <a href="privacy.php" target="_blank">Privacy Policy</a> | <a href="privacy.php"
                            target="_blank">Terms &
                            Conditions</a>
                    </p>
                </div>
