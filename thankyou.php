...
<link rel="canonical" href="https://www.MagicWorld.com/thankyou.php">
            ...
            if ($email_exist == TRUE) {
                ...
                if (!isset($_SESSION['captcha_code'])) {
                    ...
                    if ($conn_logodb->query($sql) === TRUE) {
                        ...
                        $htmlStr .= "Team MagicWorld.com";



                        $name = "Team MagicWorld";

                        $email_sender = "team@MagicWorld.com";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <table width="80" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr><td align="center" valign="top"><img src="http://www.MagicWorld.com/assets/img/binary_logo.png" alt="MagicWorld.com" width="171" height="81"></td></tr>
                                    ...
                                    <tr><td height="98" valign="middle" bgcolor="#f6f6f6">
                                        ...
                                        <table width="596" border="0" align="center" cellpadding="0" cellspacing="0" style="font:normal 13px Arial, Helvetica, sans-serif;color:#0d0d0d;padding:0px 0;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr><td width="574" height="73" align="left" valign="middle"><span style="font-size:13px;color:#302b2b;font-family:Arial, Helvetica, sans-serif;">Thank you<br>Customer Care Department<br>MagicWorld</span></td></tr>
